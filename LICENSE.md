...
## Klepsydra Toolset - Terms and conditions

1.  **Preamble:** This Agreement, signed on Aug 11, 2017 (hereinafter: Effective Date) governs the relationship between The Client, a Business Entity, (hereinafter: Licensee) and Klepsydra Robotics, a duly registered company in whose principal place of business is {location} (hereinafter: Licensor). This Agreement sets the terms, rights, restrictions and obligations on using Klepsydra Toolset (hereinafter: The Software) created and owned by Licensor, as detailed herein
