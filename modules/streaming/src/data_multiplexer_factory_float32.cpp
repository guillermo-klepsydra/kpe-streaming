...
namespace streaming {
    ...
    DataMultiplexerFactoryFloat32::DataMultiplexerPtr<kpsr::streaming::F32AlignedVector> DataMultiplexerFactoryFloat32::getDataMultiplexerF32A(const std::string& stepName, const size_t vectorSize) {
        ...
        if (multiplexer) {
            ...
            return  _dataMultiplexerProviderFactory.insertMultiplexer<DataBatchWithId<F32AlignedVector>, DATA_MULTIPLEXER_SIZE>(
                stepName,
                std::make_shared<DataMultiplexerFactoryFloat32::DataMultiplexer<kpsr::streaming::F32AlignedVector>>(
                    _container,
                    stepName,
    ...
    DataMultiplexerFactoryFloat32::DataMultiplexerPtr<std::vector<float>> DataMultiplexerFactoryFloat32::getDataMultiplexerF32(const std::string& stepName,
    ...
    DataMultiplexerFactoryFloat32::DataMultiplexerPtr<std::vector<kpsr::streaming::F32AlignedVector>> DataMultiplexerFactoryFloat32::getDataMultiplexerMF32A(const std::string& stepName,
                                                                                                 const size_t vectorSize,
        ...
        if (multiplexer) {
            ...
            return  _dataMultiplexerProviderFactory.insertMultiplexer<DataBatchWithId<std::vector<F32AlignedVector>>, DATA_MULTIPLEXER_SIZE>(
                stepName,
                std::make_shared<DataMultiplexerFactoryFloat32::DataMultiplexer<std::vector<F32AlignedVector>>>(
                    _container,
                    stepName,
    ...
    kpsr::Publisher<kpsr::streaming::DataBatchWithId<kpsr::streaming::F32AlignedVector>> * DataMultiplexerFactoryFloat32::getPublisherF32Aligned(const std::string & stepName, const size_t vectorSize) {
    ...
    kpsr::Subscriber<kpsr::streaming::DataBatchWithId<kpsr::streaming::F32AlignedVector>> * DataMultiplexerFactoryFloat32::getSubscriberF32Aligned(const std::string& stepName, const size_t vectorSize) {
    ...
    kpsr::Publisher<kpsr::streaming::DataBatchWithId<std::vector<kpsr::streaming::F32AlignedVector>>> * DataMultiplexerFactoryFloat32::getPublisherMultiF32Aligned(const std::string & stepName, const size_t vectorSize, const size_t multiVectorSize) {
    ...
    kpsr::Subscriber<kpsr::streaming::DataBatchWithId<std::vector<kpsr::streaming::F32AlignedVector>>> * DataMultiplexerFactoryFloat32::getSubscriberMultiF32Aligned(const std::string & stepName, const size_t vectorSize, const size_t multiVectorSize) {
    ...
    kpsr::Publisher<kpsr::streaming::DataBatchWithId<std::vector<float>>> * DataMultiplexerFactoryFloat32::getPublisherF32(const std::string & stepName, const size_t vectorSize) {
    ...
    kpsr::Subscriber<kpsr::streaming::DataBatchWithId<std::vector<float>>> * DataMultiplexerFactoryFloat32::getSubscriberF32(const std::string & stepName, const size_t vectorSize) {
